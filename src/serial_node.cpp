...
#include "command_msgs/position_request.h"
...
bool commandcb(command_msgs::speed_command::Request &, command_msgs::speed_command::Response &);
bool requestcb(command_msgs::position_request::Request &, command_msgs::position_request::Response &);
...
bool commandcb(command_msgs::speed_command::Request &req, command_msgs::speed_command::Response &res)
{
    if(exit_flag == false) 
    { 
...
bool requestcb(command_msgs::position_request::Request &req, command_msgs::position_request::Response &res)
{
    if(exit_flag == false) 
    { 
	ROS_DEBUG("Sending Received Data");
	...
	struct timespec shortdelay = {0, 1666667};
	bool error = true;
	float x = 0.0;
	float y = 0.0;
	float th = 0.0;
	...
	// hardcoding robot_index to 2
	error = GetData('w', req.robot_index, &x, &y, &th);
